...
const SkillLevelsPanel: React.FC<SkillLevelsPanelProps> = ({ category, onClose }) => {
  return (
    <div className="flex flex-col h-full min-h-0">
      {/* Header */}
      <div className="-mx-5 -mt-5 px-4 pt-3 pb-2 bg-gray-50 dark:bg-gray-900 border-b flex justify-between items-start">
      ...
      <div className="pt-4 pb-0 flex-1 min-h-0 flex flex-col">
        ...
        <div className="flex-1 min-h-0 flex flex-col -mx-5 px-5">
          <Skill_level_list skillCategoryId={category.id} />
        </div>
      </div>
    </div>
  );
...
export default SkillLevelsPanel;
