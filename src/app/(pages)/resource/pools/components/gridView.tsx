...
import { deletePool, disable, editResourcePool } from "@/services/resource-pool-service";
    ...
    <>
      ...
      {isDeleting && deletingPool !== null && (
        <DeleteModal
          ...
          description={`Are you sure you want to permanently delete Resource Group "${
            resourcePools.find((p) => p.resource_pool_id === deletingPool)
