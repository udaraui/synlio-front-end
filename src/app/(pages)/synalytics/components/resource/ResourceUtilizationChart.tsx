...
export default function ResourceUtilizationChart({ rows, loading }: Props) {
        ...
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} margin={{ top: 4, right: 8, left: -16, bottom: 4 }}>
              ...
              />
              <YAxis {...axisProps} tick={{ fontSize: 10, fill: axisColor }} domain={[0, 140]} unit="%" />
              <ReferenceLine y={100} stroke={CHART_COLORS.RED} strokeDasharray="4 4" label={{ value: "100%", fill: CHART_COLORS.RED, fontSize: 9, position: "insideTopRight" }} />
