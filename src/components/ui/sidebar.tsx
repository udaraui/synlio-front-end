  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:[&>div:first-child_[data-sidebar=group-label]]:hidden",
        className
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col p-2 pt-0 group-data-[collapsible=icon]:pb-0", className)}
      {...props}
    />
  )
}
